...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
            ...
            <asp:TableRow>
                <asp:TableCell>
                   ...
                   <asp:TableCell Width="100px">
                    ...
                    <br />
                    <asp:DropDownList ID="ddlSalesRepLastName" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                ...
                <asp:TableCell Width="100px">
                    ...
                    <br />
                    <asp:DropDownList ID="ddlSalesRepTypeName" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                        OnSelectedIndexChanged="ddl_SelectedIndexChanged" Width="40px">
                        <asp:ListItem Selected="True">Select One</asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
                 ...
                 <asp:TableCell Width="100px">
                    ...
                    <br />
                    <asp:DropDownList ID="ddlTerritoryName" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                        OnSelectedIndexChanged="ddl_SelectedIndexChanged" Width="40px">
                        <asp:ListItem Selected="True">Select One</asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
                  ...
                  <asp:TableCell Width="100px">
                    ...
                    <br />
                    <asp:DropDownList ID="ddlRegionName" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                        OnSelectedIndexChanged="ddl_SelectedIndexChanged" Width="40px">
                        <asp:ListItem Selected="True">Select One</asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
                  ...
                  <asp:TableCell Width="100px">
                    ...
                    <br />
                    <asp:DropDownList ID="ddlDistributionRegionName" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                        OnSelectedIndexChanged="ddl_SelectedIndexChanged" Width="40px">
                        <asp:ListItem Selected="True">Select One</asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
        ...
        <asp:GridView ID="SalesRepresentativeGridView" runat="server" AutoGenerateColumns="false"
        ...
        <asp:Label ID="Label15" runat="server" Text="" Font-Size="Large" Style="text-align: left;">Add New Sales Representaive</asp:Label>
                ...
                <asp:TableCell runat="server">
                    ...
                    <asp:TableRow runat="server">
                        ...
                        <asp:TableCell runat="server">Inventory Notes:</asp:TableCell>
                        <asp:TableCell runat="server">
